...
class EventDialog(QWidget):
    ...
    def _on_save(self):
        ...
        if self.is_new:
            ...
            # Get the underlying ImmutableEvent for modification
            # (EventInstanceV2.event is the EventInstanceV2 itself)
            cal_event = self.event_data
    ...
    def _on_delete(self):
        ...
        # Get the underlying EventInstanceV2 for deletion
        cal_event = self.event_data
